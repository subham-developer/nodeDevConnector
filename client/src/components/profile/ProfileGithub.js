...
import { getGitubRepos } from '../../actions/profile';

const ProfileGithub = ({ getGitubRepos, repos, username }) => {
    useEffect(()=>{
        getGitubRepos(username);
    },[getGitubRepos, username ]);
...
ProfileGithub.propTypes = {
    getGitubRepos: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { getGitubRepos } )(ProfileGithub);
