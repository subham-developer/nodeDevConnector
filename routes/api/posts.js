...
router.delete("/:post_id", [auth], async(req, res) => {
    try {
        ...
        // Check Post belongs to same user
...
router.put("/like/:post_id", [auth], async(req, res) => {
    try {
        ...
        // Check if the post has already been liked by logged in user
...
router.delete("/comment/:post_id/:comment_id", [auth], async(req, res) => {
    try {
        ...
        // Get remove index
        const removeIndex = await post.comments.map(comments => comments.user.toString().indexOf(req.user.id));
